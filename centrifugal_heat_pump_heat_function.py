        ...
        while chph1_load_ratio <= 1 + gc.load_ratio_error_coefficient:
            ...
            if chph_heat_out_now_sum < heat_load:
                ...
                chph_power_consumption_total = chph1_centrifugal_heat_pump_power_consumption + chph2_centrifugal_heat_pump_power_consumption \
                                               ...
                                               + chph1_auxiliary_equipment_power_consumption + chph2_auxiliary_equipment_power_consumption \
...
def centrifugal_heat_pump_cost_heat(chph, gc, load_ratio):
    ...
    # 辅助设备耗电功率,某一负荷率条件下
    auxiliary_equipment_power_consumption = chph.auxiliary_equipment_power_consumption(heat_source_water_flow, heating_water_flow)[0]
    # 采暖水泵频率和热源水泵频率
    wp_frequency_heating_water = chph.auxiliary_equipment_power_consumption(heat_source_water_flow, heating_water_flow)[1]
    wp_frequency_heat_source_water = chph.auxiliary_equipment_power_consumption(heat_source_water_flow, heating_water_flow)[2]
    # 离心式热泵总耗电功率,某一负荷率条件下
    ...
    # 返回计算结果
    return cost_total, total_power_consumption, total_water_supply, centrifugal_heat_pump_power_consumption, heating_water_flow, \
           heat_source_water_flow, wp_frequency_heating_water, wp_frequency_heat_source_water
