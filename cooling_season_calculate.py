...
def print_cooling_season(ans, ice1, ice2, lb1_wp_cooling_water, lb2_wp_cooling_water, lb1_wp_chilled_water, lb2_wp_chilled_water, lb1_wp_hot_water,
    ...
    # 批量写入24小时折现图数据
    wtd.write_to_database_cold_actual_24(syncbase, datetime.datetime.now(), gc.period)
    ...
    wtd.write_to_database_chp_cold_electricity_consumption_24(syncbase, datetime.datetime.now(), gc.period)
    ...
    wtd.write_to_database_lb_cold_out_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_cc_cold_out_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_chp_cold_out_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_ashp_cold_out_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_ese_cold_out_24(syncbase, datetime.datetime.now(), gc.period)
    ...
    wtd.write_to_database_lb_cold_income_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_lb_hot_water_income_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_cc_cold_income_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_chp_cold_income_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_ashp_cold_income_total_24(syncbase, datetime.datetime.now(), gc.period)
    ...
    wtd.write_to_database_lb_cold_cost_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_lb_hot_water_cost_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_cc_cold_cost_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_chp_cold_cost_total_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_ashp_cold_cost_total_24(syncbase, datetime.datetime.now(), gc.period)
    ...
    wtd.write_to_database_lb_cold_efficiency_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_lb_hot_water_efficiency_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_cc_cold_cop_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_chp_cold_cop_24(syncbase, datetime.datetime.now(), gc.period)
    wtd.write_to_database_ashp_cold_cop_24(syncbase, datetime.datetime.now(), gc.period)
