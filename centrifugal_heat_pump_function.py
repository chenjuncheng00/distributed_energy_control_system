...
def test_centrifugal_heat_pump_function_heat():
    ...
    heat_load = 15000
    chp_wp = False
    chp1_wp_heating_water = Water_Pump(900, chp_wp, 35, gc)
    chp2_wp_heating_water = Water_Pump(900, chp_wp, 35, gc)
    chp3_wp_heating_water = Water_Pump(900, chp_wp, 35, gc)
    chp4_wp_heating_water = Water_Pump(900, chp_wp, 35, gc)
    chp1_wp_heat_source_water = Water_Pump(700, chp_wp, 35, gc)
    chp2_wp_heat_source_water = Water_Pump(700, chp_wp, 35, gc)
    chp3_wp_heat_source_water = Water_Pump(700, chp_wp, 35, gc)
    chp4_wp_heat_source_water = Water_Pump(700, chp_wp, 35, gc)
